...
export function init(router) {
    ...
    function createFeedbackIcon(icon, type) {
        ...
        btn.onclick = async () => {
            ...
            // Send Data
            await feedbackService.send({ type, value: type, source: 'premium' });

            // Simple Toast
            showToast("Дякуємо за вашу думку! 💜");
        };
    ...
    function openFeedbackModal() {
        ...
        sendBtn.onclick = async () => {
            ...
            // Assuming 'upsell' context since this button is only visible after upsell
            await feedbackService.send({ type: 'text', value: textarea.value, source: 'premium_upsell' });
