/**
 * 🌌 NATAL_CHART_PRICE - Варіант для продажу натальної карти з комбінованим екраном результат+форма
 * URL: /natal_chart_price
 * Структура: Як у /man — поля часу та міста з'являються одразу під безкоштовним звітом
 */
export const natalChartPriceConfig = {
    id: 'natal_chart_price',
    type: 'product',
    enabled: true,
...
<div style="padding-left: 24px; position: relative;">
    ...
    tracking: {
        campaignName: 'natal_chart_price',
        customPixelEvent: 'ViewContent_NatalChartPrice'
    }
};
